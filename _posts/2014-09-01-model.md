...
<span style="color: red">★consoleの終了方法が記載されているといいかなと思いました。
分からずにググってしまったので…</span>
...
ちなみに、ちなみに、<span style="color: red">★「ちなみに」が多いですか？</span>Railsのgenerate機能は開発をアシストする機能なので、使わないで0から手でコードを書いても同様に動きます。rails gを使ってファイルを作っても、0から手でコードを書いても同じ結果になります。以下の図を参考にしてください。
